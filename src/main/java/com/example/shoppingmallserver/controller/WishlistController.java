...
public class WishlistController {
    ...
    public ResponseEntity<SuccessResponse<List<ItemCartInquiryResponseDto>>> getWishlistItemList(@PathVariable @Parameter(description = "사용자 ID(PK)", example = "1") Long userId) {
